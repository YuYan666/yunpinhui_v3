...
$_LANG['p_y']['link_start'] = '<a href="http://www.we10.cn" target="_blank" style=" font-family:Verdana; font-size:11px;">';
...
/* 代码增加_start  By  www.yurenmall.com 虚拟销量 */
$_LANG['sales_volume_total'] = '累计销量：';   
$_LANG['pcs'] = '件';  
/* 代码增加_end  By  www.yurenmall.com 虚拟销量 */
