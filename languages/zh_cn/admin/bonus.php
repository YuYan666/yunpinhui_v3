...
$_LANG['send_by'][SEND_BY_ORDER] = '按订单金额发放(入驻商订单需要在商家后台设置)';
$_LANG['send_by'][SEND_BY_PRINT] = '关注送红包、首页领取红包';
$_LANG['send_by'][SEND_BY_REGISTER] = '按注册用户发放（仅限手机号注册有效）';  //代码增加   By  www.we10.cn
