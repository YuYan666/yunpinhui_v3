...
//开始位置_新增加 by www.we10.cn
$_LANG['cfg_name']['oss_access_id'] = 'Access Key ID';
$_LANG['cfg_name']['oss_access_key'] = 'Access Key Secret';
$_LANG['cfg_name']['oss_region'] = 'OSS所属地域';
$_LANG['cfg_range']['oss_region']['0'] = '杭州';
$_LANG['cfg_range']['oss_region']['1'] = '深圳';
$_LANG['cfg_range']['oss_region']['2'] = '北京';
$_LANG['cfg_range']['oss_region']['3'] = '青岛';
$_LANG['cfg_range']['oss_region']['4'] = '上海';
$_LANG['cfg_range']['oss_region']['5'] = '香港';
$_LANG['cfg_range']['oss_region']['6'] = '美国硅谷';
$_LANG['cfg_range']['oss_region']['7'] = '亚太(新加坡)';
$_LANG['cfg_name']['oss_bucket'] = 'Bucket名称';
$_LANG['cfg_name']['oss_binding_domain'] = 'OSS自定义域名';
$_LANG['cfg_name']['oss_display_mode'] = '显示模式';
$_LANG['cfg_range']['oss_display_mode']['0'] = 'OSS外网域名';
$_LANG['cfg_range']['oss_display_mode']['1'] = '自定义域名';
$_LANG['cfg_range']['oss_display_mode']['2'] = '本地路径';
$_LANG['cfg_desc']['oss_bucket'] = '注意：这种如果为空，则默认不上传图片到OSS存储,如果设置请先开通阿里云OSS服务否则无法上传商城图片';
$_LANG['cfg_desc']['oss_binding_domain'] = '注意：请不用带上https或则https';
//结束位置_新增加 by www.we10.cn
...
$_LANG['cfg_desc']['shop_logo'] = '注意：图片大小为250*60,请在上传前将图片的文件名命名为logo.gif';
...
$_LANG['cfg_name']['shouyin_percent'] = 'O2O付款提成比例';
...
$_LANG['cfg_name']['wxnotice_order_payed'] = '下单通知管理员微信';
$_LANG['cfg_range']['wxnotice_order_payed']['1'] = '发微信';
$_LANG['cfg_range']['wxnotice_order_payed']['0'] = '不发微信';
$_LANG['cfg_name']['wxnotice_order_payed_guanli'] = '管理员ID';
...
/* 代码增加_注册红包end  By  www.we10.cn */

$_LANG['cfg_name']['shop_opint'] = '店铺坐标';

/*新增甜心100  后台可以上传二维码图片*/

$_LANG['cfg_name']['erweima_image'] = '微信二维码';

$_LANG['cfg_desc']['erweima_image'] = '注意：图片大小为250*250,上传前请把图片重命名为erweima.png';

/*新增甜心100  后台可以上传二维码图片*/
/* 虚拟销售可自定义带自动刷新版_新增加 开始 by www.yurenmall.com */
$_LANG['cfg_name']['show_goods_sales'] = '是否显示商品累计销量';
$_LANG['cfg_range']['show_goods_sales']['1'] = '显示';
$_LANG['cfg_range']['show_goods_sales']['0'] = '不显示';
$_LANG['cfg_name']['show_sales_type'] = '商品累计销量默认显示模式';
$_LANG['cfg_range']['show_sales_type'][1] = '真实显示';
$_LANG['cfg_range']['show_sales_type'][2] = '真实虚拟混合显示（手动）';
$_LANG['cfg_range']['show_sales_type'][3] = '真实虚拟混合显示（自动）';
$_LANG['cfg_name']['auto_sales_amount'] = '自动生成虚拟销售数量';
$_LANG['cfg_desc']['auto_sales_amount'] = '如填写1-1，表示1数量。如填写100-1000，表示100到1000之间随机一个数作为销售数量';
$_LANG['cfg_name']['auto_sales_hours'] = '同一商品两次虚拟销售数量间隔时间（分钟）';
$_LANG['cfg_desc']['auto_sales_hours'] = '如填写1-1，表示1分钟。如填写12-30，表示时间隔为12与30分钟的随机数。';



$_LANG['cfg_name']['mini'] = '小程序设置';
$_LANG['cfg_name']['appid'] = '小程序APPID';
$_LANG['cfg_name']['appsecret'] = '小程序appsecret';
$_LANG['cfg_name']['key'] = '小程序key';
$_LANG['cfg_name']['machid'] = '小程序machid';

$_LANG['cfg_name']['kdniao'] = '快递鸟设置';
$_LANG['cfg_name']['kdapppid'] = '用户ID';
$_LANG['cfg_name']['kdappkey'] = 'API key';

$_LANG['cfg_name']['service_method'] = '客服方式';
$_LANG['cfg_range']['service_method'][0] = '电话';
$_LANG['cfg_range']['service_method'][1] = 'QQ';
$_LANG['cfg_range']['service_method'][2] = '百度商桥';
$_LANG['cfg_range']['service_method'][3] = '阿里云旺';
$_LANG['cfg_range']['service_method'][4] = '合从客服';
$_LANG['cfg_name']['shangqiao_siteId'] = '百度商桥siteId';
$_LANG['cfg_name']['shangqiao_userId'] = '百度商桥userId';
$_LANG['cfg_name']['hecong_userId'] = '合从客服userId';
/* 虚拟销售可自定义带自动刷新版_新增加 结束 by www.yurenmall.com */
?>