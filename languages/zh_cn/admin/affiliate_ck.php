...
$_LANG['order_stats'][0][0] = '未确认';
$_LANG['order_stats'][1][0] = '已确认';
$_LANG['order_stats'][2][0] = '已取消';
$_LANG['order_stats'][3][0] = '无效';
$_LANG['order_stats'][4][0] = '退货';
$_LANG['order_stats'][5][1] = '已经发货';
$_LANG['order_stats'][5][2] = '确认收货';
