...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    /* 网址 */
    $modules[$i]['website'] = 'http://www.z1988.com';
    /* 版本号 */
    ...
    $modules[$i]['config'] = array(
		...
		array('name' => 'unionpay_account_pm', 'type' => 'text', 'value' => '700000000000001'),
...
class unionpay
{
	...
	function config($payment)
    {
		...
		if ( $unionpay_evn == '1' ){  // 生产环境
			...
			$data['unionpay_verify_cert_path']	= $data['unionpay_verify_dir'] . 'EbppRsaCert.cer';
			$data['unionpay_encrypt_cert_path'] = $data['unionpay_verify_dir'] . 'encryptpub.cer';
			...
			$data['unionpay_sign_cert_pwd']		= '000000';
			$data['unionpay_sign_cert_path']	= $data['unionpay_verify_dir'] . 'PM_700000000000001_acp.pfx';
			$data['unionpay_verify_cert_path']	= $data['unionpay_verify_dir'] . 'verify_sign_acp.cer';
			$data['unionpay_encrypt_cert_path'] = $data['unionpay_verify_dir'] . 'encrypt.cer';
...
eot;
		...
		$html .= ' <input type="submit" value="确认支付" class=" sub_btn"> </form>';
        return $html;
    }
