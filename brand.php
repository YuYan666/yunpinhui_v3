...
{	
    ...
    $brand_info['brand_logo'] = (OSS_DISPLAY_MODE===0) ? OSS_DOMAIN . 'data/brandlogo/' . $brand_info['brand_logo'] : (OSS_DISPLAY_MODE==1 ? OSS_BINDING_DOMAIN . 'data/brandlogo/' . $brand_info['brand_logo'] : 'data/brandlogo/'.$brand_info['brand_logo']); //新增加 by www.we10.cn
