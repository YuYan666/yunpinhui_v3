...
/*------------------------------------------------------ */
//-- 内容测试区 --靳
// $supplier_id = $db->getOne("SELECT supplier_id FROM " . $GLOBALS['ecs']->table('order_info') ." WHERE order_id = '0'");
//     if($supplier_id == 0){
//         //自营
//         $affiliate = unserialize($db->getOne("SELECT value FROM" . $GLOBALS['ecs']->table('shop_config') ."WHERE code = 'affiliate'"));
//     }else{
//         //入驻商
//         $affiliate = unserialize($db->getOne("SELECT affiliate FROM" . $GLOBALS['ecs']->table('supplier') ."WHERE supplier_id = '$supplier_id'"));
//     }
    
// var_dump($affiliate);
// echo '<hr>';
// $a = unserialize($GLOBALS['_CFG']['affiliate']);
// // var_dump();
// if($affiliate === $a){
//     echo 123;
// }
...
// // 
// echo '<pre>';
// $a = 'a:3:{s:6:"config";a:7:{s:6:"expire";d:24;s:11:"expire_unit";s:4:"hour";s:11:"separate_by";i:0;s:15:"level_point_all";s:2:"5%";s:15:"level_money_all";s:2:"1%";s:18:"level_register_all";i:2;s:17:"level_register_up";i:60;}s:4:"item";a:3:{i:0;a:2:{s:11:"level_point";d:0;s:11:"level_money";s:3:"10%";}i:1;a:2:{s:11:"level_point";d:0;s:11:"level_money";s:3:"10%";}i:2;a:2:{s:11:"level_point";d:0;s:11:"level_money";s:3:"20%";}}s:2:"on";i:1;}';
// $b = unserialize($a);
// var_dump($b);
// echo '</pre>';


// $is_separate = $db->getOne("SELECT supplier_id FROM " . $GLOBALS['ecs']->table('order_info') ." WHERE order_id = '4'");
// echo '<pre>';
// var_dump($is_separate);
...
function get_affiliate()
{
    ...
    $sql = "SELECT `affiliate` FROM ". $GLOBALS['ecs']->table('supplier')." WHERE supplier_id=".$_SESSION['supplier_id'];
    $aa = $GLOBALS['db']->query($sql);
    while($row = mysql_fetch_array($aa)){
        $config = $row['affiliate'];
    }
...
function put_affiliate($config)
{
    ...
    $sql = "UPDATE " . $GLOBALS['ecs']->table('supplier',1) .
           "SET affiliate  = '$temp'" .
