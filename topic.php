...
//                "WHERE " . db_create_in($goods_id, 'g.goods_id');
    ...
    $topic['topic_img'] = (OSS_DISPLAY_MODE==0) ? OSS_DOMAIN . $topic['topic_img'] : (OSS_DISPLAY_MODE==1 ? OSS_BINDING_DOMAIN . $topic['topic_img'] : $topic['topic_img']); //新增加 by www.we10.cn
    $topic['title_pic'] = (OSS_DISPLAY_MODE==0) ? OSS_DOMAIN . $topic['title_pic'] : (OSS_DISPLAY_MODE==1 ? OSS_BINDING_DOMAIN . $topic['title_pic'] : $topic['title_pic']); //新增加 by www.we10.cn
    /* 模板赋值 */
    assign_template();
