...
function index_get_links()
{
    ...
    foreach ($res AS $row)
    {
        ...
        {
            $row['link_logo'] = (OSS_DISPLAY_MODE==0) ? OSS_DOMAIN . $row['link_logo'] : (OSS_DISPLAY_MODE==1 ? OSS_BINDING_DOMAIN . $row['link_logo'] : $row['link_logo']); //新增加 by www.we10.cn
