...
class WxHongBaoHelper 
{
	...
	function curl_post_ssl($url,$vars,$second=30,$aHeader=array()) 
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT,ROOT_PATH.DS.'cert'.DS.'apiclient_cert.pem');
		curl_setopt($ch,CURLOPT_SSLKEY,ROOT_PATH.DS.'cert'.DS.'apiclient_key.pem');
		curl_setopt($ch,CURLOPT_CAINFO,ROOT_PATH.DS.'cert'.DS.'rootca.pem');
		if( count($aHeader) >= 1 )
		{
