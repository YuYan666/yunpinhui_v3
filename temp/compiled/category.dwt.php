...
?> 
        ...
        <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('kattr', 'filter_attr_0_49555700_1543867671');$this->_foreach['filter_attr_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_attr_list']['total'] > 0):
    foreach ($_from AS $this->_var['kattr'] => $this->_var['filter_attr_0_49555700_1543867671']):
...
?>
        <dl name="attr-group-dl" id="attr-group-dl-<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>">
          <dt><?php echo htmlspecialchars($this->_var['filter_attr_0_49555700_1543867671']['filter_attr_name']); ?>：</dt>
          <dd class="moredd">
          ...
          <dd>
            <ul id="attr-abox-<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>">
              <?php $_from = $this->_var['filter_attr_0_49555700_1543867671']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');$this->_foreach['attr_list_68ecshop'] = array('total' => count($_from), 'iteration' => 0);
...
?> 
              ...
              <li class="<?php if ($this->_var['filter_attr_0_49555700_1543867671']['filter_attr_name'] == '颜色'): ?>color-ecshop68-li<?php else: ?>other-ecshop68-li<?php endif; ?>"> <?php if ($this->_var['filter_attr_0_49555700_1543867671']['filter_attr_name'] == '颜色'): ?> <span class="color-ecshop68" style="position:relative;">
...
?> 
                        ...
                        <li>
                            <div class="p-img">
                                <a target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" href="<?php echo $this->_var['goods']['url']; ?>"><img alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" data-original="<?php echo $this->_var['goods']['thumb']; ?>" src="themes/wwwwe10cn/images/loading.gif" /></a> 
                            </div>
                            <div class="p-name">
