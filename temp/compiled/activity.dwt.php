...
<link rel="stylesheet" href="themes/wwwwe10cn/css/activity.css">
...
<div class="margin-w1210 clearfix">
    ...
    <div class="tgoulist">
      <div id="slider" class="actice-info fl">
...
?>
        <div class="list-biaoti" id="tg<?php echo $this->_foreach['name']['iteration']; ?>">
          <h3 class="main-color"><i id="<?php echo $this->_var['val']['act_type_num']; ?>"></i>活动<?php echo $this->_foreach['val']['iteration']; ?>&nbsp;•&nbsp;&nbsp;<?php echo $this->_var['val']['act_name']; ?>
        ...
        <div class="list-tuangou">
          <div class="list-tt">
            <div class="fl"><img data-original="<?php echo empty($this->_var['val']['logo']) ? 'images/ceshi.jpg' : $this->_var['val']['logo']; ?>" src="themes/wwwwe10cn/images/loading-big.gif" height="260" width="580"></div>
            <div class="active-desc fr">
              <h3><i></i><?php echo $this->_var['lang']['label_end_time']; ?><span class="main-color"><?php echo $this->_var['val']['end_time']; ?></span></h3>
...
?> 
                <a href="<?php echo $this->_var['val']['program']; ?><?php echo $this->_var['ext']['id']; ?>" taget="_blank"><span class="f_user_info main-color"><u><?php echo $this->_var['ext']['name']; ?></u></span></a> 
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
                <?php endif; ?></p>
...
?>
            <table border="0" <?php if (($this->_foreach['name1']['iteration'] <= 1)): ?>style="margin-left:30px;"<?php endif; ?>>
              <tr>
                <td align="center"><a href="goods.php?id=<?php echo $this->_var['goods']['id']; ?>" class="thumb"><img data-original="<?php echo $this->_var['goods']['thumb']; ?>" src="themes/wwwwe10cn/images/loading.gif" alt="<?php echo $this->_var['goods']['name']; ?>" width="160" height="160" /></a></td>
              </tr>
              <tr>
                <td align="center"><a href="goods.php?id=<?php echo $this->_var['goods']['id']; ?>" title="<?php echo $this->_var['goods']['name']; ?>"><?php echo sub_str($this->_var['goods']['name'],16); ?></a></td>
              </tr>
              <tr>
                <td align="center" class="main-color"><?php if ($this->_var['goods']['price'] > 0): ?> 
      ...
      <div class="tupian fr">
        <ul class="hdleft">
          <li class="hdl">
          	<div class="active-type"><a href="activity.php#0" title="享受赠品">享受赠品</a></div>
            <div class="vel"></div>
           </li>
          <li class="hdl">
          	<div class="active-type"><a href="activity.php#1" title="现金减免">现金减免</a></div>
          	<div class="vel"></div>  
          </li>
          <li class="hdl">
          	<div class="active-type"><a href="activity.php#2" title="价格折扣">满减活动</a></div>
          	<div class="vel"></div>  
          </li>
          <li class="hdl gotop">
          	<div class="active-type top"><a href="javascript:;">返回顶部</a></div>
          </li>
        </ul>
      </div>
    </div>
