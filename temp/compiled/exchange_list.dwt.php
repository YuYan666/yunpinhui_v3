...
<link rel="stylesheet" type="text/css" href="themes/wwwwe10cn/css/exchange.css" />
        ...
        <table id="JS_slide_stage" cellpadding="0" spellcheck="0" border="0">
          <tbody>
            <tr>
              ...
              <td> <?php $this->assign('ads_id','54'); ?><?php $this->assign('ads_num','0'); ?><?php echo $this->fetch('library/ad_position.lbi'); ?> </td>
            </tr>
          </tbody>
        </table>
      </div>
