    ...
    <div class="browse-history-con">
    	<div class="browse-history-inner">
            ...
            <ul class="recommend-panel">
                <?php $_from = $this->_var['cainixihuan']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_55805700_1543867671');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_55805700_1543867671']):
?>
                <li>
                    <div class="p-img"><a target="_blank" title="<?php echo $this->_var['goods_0_55805700_1543867671']['goods_name']; ?>" href="<?php echo $this->_var['goods_0_55805700_1543867671']['url']; ?>"><img alt="<?php echo $this->_var['goods_0_55805700_1543867671']['goods_name']; ?>" src="<?php echo $this->_var['goods_0_55805700_1543867671']['goods_thumb']; ?>"></a></div>
                    <div class="p-name"><a target="_blank" title="<?php echo $this->_var['goods_0_55805700_1543867671']['goods_name']; ?>" href="<?php echo $this->_var['goods_0_55805700_1543867671']['url']; ?>"><?php echo $this->_var['goods_0_55805700_1543867671']['goods_name']; ?></a></div>
                  	<div class="p-comm">
                    	<span class="p-price main-color"><?php echo $this->_var['goods_0_55805700_1543867671']['shop_price']; ?></span>
                        <a class="p-comm-num" target="_blank" href="<?php echo $this->_var['goods_0_55805700_1543867671']['url']; ?>">评论：<?php echo $this->_var['goods_0_55805700_1543867671']['evaluation']; ?></a>
                    </div>
                </li>
