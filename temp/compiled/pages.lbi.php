<form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
  ...
  <div class="page">
    <div class="page-wrap fr">
		...
		<?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_41743200_1543867659');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_41743200_1543867659']):
?> 
		<?php if ($this->_var['key'] == 'keywords'): ?>
		<input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo urldecode($this->_var['item_0_41743200_1543867659']); ?>" />
		<?php else: ?>
		<input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_41743200_1543867659']; ?>" />
		<?php endif; ?> 
  ...
  <div class="page">
    <div class="page-wrap fr"> 
    	<div class="page-num fl">
            ...
            <?php endif; ?>
			<?php if ($this->_var['pager']['page_count'] != 1): ?> 
			<?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_41743200_1543867659');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_41743200_1543867659']):
?> 
			<?php if ($this->_var['pager']['page'] == $this->_var['key']): ?> 
			<span class="num curr"><?php echo $this->_var['key']; ?></span> 
			<?php else: ?> 
			<a class="num" href="<?php echo $this->_var['item_0_41743200_1543867659']; ?>"><?php echo $this->_var['key']; ?></a> 
			<?php endif; ?> 
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
			<?php endif; ?> 
