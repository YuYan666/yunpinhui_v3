...
<link type="text/css" rel="stylesheet" href="themes/wwwwe10cn/css/passport.css" />
<script type="text/javascript" src="themes/wwwwe10cn/js/jquery_email.js"></script>
<script type="text/javascript" src="themes/wwwwe10cn/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="themes/wwwwe10cn/js/validate/jquery.validate.js"></script>
<script type="text/javascript" src="themes/wwwwe10cn/js/validate/messages_zh.js"></script>
<script type="text/javascript" src="themes/wwwwe10cn/js/placeholder.js"></script>
...
<div class="logo-r">
  <div class="logo-info-r"> <a href="./" class="logo"></a> <span class="findpw">找回密码</span> <?php echo $this->fetch('library/user_right.lbi'); ?> </div>
</div>
<div class="w990"> 
      ...
      <div id="find-box" class="uc-box">
        <div class="find-pwd-con"> 
          ...
          <form action="findPwd.php?XDEBUG_SESSION_START=ECLIPSE_DBGP" method="post" id="fpForm" name="fpForm">
            ...
            <div class="item">
              <label>验证码</label>
              <input type="text" id="captcha" name="captcha" tabindex="2" placeholder="请输入<?php echo $this->_var['lang']['comment_captcha']; ?>" autocomplete="off" class="text text-te" />
              <label class="img" style="margin-left: 5px"> <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle; cursor: pointer; height: 35px;" onClick="this.src='captcha.php?'+Math.random()" /> </label>
            </div>
            <div class="item">
              <label></label>
      ...
      <div id="find-box" class="uc-box">
        <form action="findPwd.php" method="post" id="fpForm" name="fpForm">
          <div class="find-pwd-con">
            ...
            <div id="error_container"></div>
            <?php if ($this->_var['validate_types_length'] > 0): ?>
            <div class="item">
      ...
      <div id="find-box" class="uc-box">
        <div class="find-pwd-con">
          <div class="find-box-end">
            <p> <i></i> 新密码设置成功！ </p>
            <p>请您牢记新密码！</p>
            <a class="main-btn on-go" href="user.php" title="立即购物">立即登录&gt;&gt;</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div id="login-box" class="uc_box">
        <form action="user.php" method="post" name="getPassword" onsubmit="return submitPwdInfo();">
          <div class="form">
            ...
            <div class="item"> <span class="label"><?php echo $this->_var['lang']['username']; ?></span>
              <div>
                <input name="user_name" type="text" class="text" />
              </div>
            </div>
            <div class="item"> <span class="label"><?php echo $this->_var['lang']['email']; ?></span>
              <div>
      ...
      <div id="login-box" class="uc_box">
        <form action="user.php" method="post">
          <div class="form">
            ...
            <div class="item"> <span class="label"><?php echo $this->_var['lang']['passwd_question']; ?>：</span>
              <div><?php echo $this->_var['passwd_question']; ?></div>
            </div>
            <div class="item"> <span class="label"><?php echo $this->_var['lang']['passwd_answer']; ?>：</span>
              <div>
                <input name="passwd_answer" type="text" class="text" />
              </div>
            </div>
            <div class="item"> <span class="label"><?php echo $this->_var['lang']['comment_captcha']; ?>：</span>
              <div>
