...
?>
          <dl class="col-article <?php if (($this->_foreach['no']['iteration'] <= 1)): ?>col-article-first<?php endif; ?>">
            ...
            <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_63618200_1543833660');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_63618200_1543833660']):
?>
            <dd><a rel="nofollow" href="help.php?id=<?php echo $this->_var['item_0_63618200_1543833660']['article_id']; ?>" target="_blank"><?php echo $this->_var['item_0_63618200_1543833660']['short_title']; ?></a></dd>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </dl>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          <dl class="col-article">
                <dt>服务支持</dt>
                <dd>售前咨询 <?php echo $this->_var['service_phone']; ?></dd>
                <dd>售后咨询 <?php echo $this->_var['service_phone']; ?></dd>
                <dd>客服 QQ <?php $_from = $this->_var['qq']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'q');if (count($_from)):
    foreach ($_from AS $this->_var['q']):
?><?php echo $this->_var['q']; ?>、<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></dd>
...
?>
        ...
        <p class="nav_bottom">
            ...
            <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_63618200_1543833660');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_63618200_1543833660']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
            <a href="<?php echo $this->_var['nav_0_63618200_1543833660']['url']; ?>"  <?php if ($this->_var['nav_0_63618200_1543833660']['opennew'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $this->_var['nav_0_63618200_1543833660']['name']; ?></a><em <?php if (($this->_foreach['nav_bottom_list']['iteration'] == $this->_foreach['nav_bottom_list']['total'])): ?>style="display:none"<?php endif; ?>>|</em>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <?php endif; ?>
            <?php if ($this->_var['icp_number']): ?>
            <?php echo $this->_var['lang']['icp_number']; ?>:<a href="https://www.miibeian.gov.cn/" target="_blank"><?php echo $this->_var['icp_number']; ?></a>
            <?php endif; ?>
        </p>
        <p>
...
?>
          <?php if ($this->_var['im']): ?>
          <a href="https://wpa.qq.com/msgrd?V=1&amp;uin=<?php echo $this->_var['im']; ?>&amp;Site=<?php echo $this->_var['shop_name']; ?>&amp;Menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=1:<?php echo $this->_var['im']; ?>:4" height="16" border="0" alt="QQ" /> <?php echo $this->_var['im']; ?></a>
          <?php endif; ?>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
          <?php if ($this->_var['im']): ?>
          <a href="https://edit.yahoo.com/config/send_webmesg?.target=<?php echo $this->_var['im']; ?>n&.src=pg" target="_blank"><img src="themes/wwwwe10cn/images/yahoo.gif" width="18" height="17" border="0" alt="Yahoo Messenger" /> <?php echo $this->_var['im']; ?></a>
          <?php endif; ?>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
          <?php if ($this->_var['im']): ?>
          <img src="themes/wwwwe10cn/images/msn.gif" width="18" height="17" border="0" alt="MSN" /> <a href="msnim:chat?contact=<?php echo $this->_var['im']; ?>"><?php echo $this->_var['im']; ?></a>
          <?php endif; ?>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
          <?php if ($this->_var['im']): ?>
          <img src="https://mystatus.skype.com/smallclassic/<?php echo urlencode($this->_var['im']); ?>" alt="Skype" /><a href="skype:<?php echo urlencode($this->_var['im']); ?>?call"><?php echo $this->_var['im']; ?></a>
          <?php endif; ?>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </p>
      </div>      
