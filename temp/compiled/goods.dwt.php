...
?> 
               ...
               <div id="summary-qita">
                  <ul class="qita">
					...
					<?php if ($this->_var['cfg']['show_goods_sales']): ?> 
					<p>累计销量<span><?php 
$k = array (
  'name' => 'sales_count',
...
?><?php if ($this->_var['goods']['measure_unit']): ?><?php echo $this->_var['goods']['measure_unit']; ?><?php else: ?><?php echo $this->_var['lang']['pcs']; ?><?php endif; ?></span></p>
                    </li>
					<?php endif; ?> 
...
?> 
                          <a onclick="show_attr_status(this,<?php echo $this->_var['goods']['goods_id']; ?>, <?php echo $this->_var['attr_id']; ?>);<?php if ($this->_var['spec_key'] == $this->_var['attr_id']): ?>get_gallery_attr(<?php echo $this->_var['id']; ?>, <?php echo $this->_var['value']['id']; ?>);<?php endif; ?>"  <?php if ($this->_var['value']['attr_img']): ?>  rel="zoom-id: zoom;" rev="<?php echo $this->_var['value']['attr_img']; ?>"  href="<?php echo $this->_var['value']['attr_img']; ?>" <?php else: ?>href="javascript:;" <?php endif; ?> name="<?php echo $this->_var['value']['id']; ?>" id="xuan_a_<?php echo $this->_var['value']['id']; ?>"  title="" <?php if ($this->_var['value']['disabled'] == 'disabled' && $this->_var['spec_count'] == 1): ?>class="wuxiao"<?php endif; ?>>
                      ...
                      <?php elseif ($this->_var['value']['attr_img'] != ''): ?>
                          <div class="spec-img"><img src="<?php echo $this->_var['value']['attr_thumb']; ?>" width=40 height=40 title="<?php echo $this->_var['value']['label']; ?>" alt="<?php echo $this->_var['value']['label']; ?>" /></div>
...
?>
          ...
          <div class="mc" id="os_jieshao">
            ...
            <?php if ($this->_var['video']): ?>
            <video style="width: 100%;" ishivideo="true" controls="controls" poster="" isrotate="false" autoHide="true">
                <source src="<?php echo $this->_var['video']; ?>" type="video/mp4">
            </video>
            <?php endif; ?>
