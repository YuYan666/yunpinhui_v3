...
<link rel="stylesheet" type="text/css" href="themes/wwwwe10cn/css/index.css" />
<script type="text/javascript" src="themes/wwwwe10cn/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="themes/wwwwe10cn/js/jump.js"></script>
<script type="text/javascript" src="themes/wwwwe10cn/js/tab.js"></script>
...
<?php $this->assign('cat_goods',$this->_var['cat_goods_6']); ?><?php $this->assign('goods_cat',$this->_var['goods_cat_6']); ?><?php $this->assign('sort_order',$this->_var['goods_cat_6_sort_order']); ?><?php $this->assign('ext_info',$this->_var['goods_cat_6_ext_info']); ?><?php echo $this->fetch('library/cat_goods.lbi'); ?>
    ...
    <script type="text/javascript" src="themes/wwwwe10cn/js/indexPrivate.min.js"></script>
