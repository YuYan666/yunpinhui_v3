...
?>
  <div class="flow-item first"> 
  	<a href="supplier.php?suppId=<?php echo $this->_var['shop']['supplier_id']; ?>" class="flow-datu" title="<?php echo $this->_var['shop']['shop_name']; ?>"> 
    	<img title="<?php echo $this->_var['shop']['supplier_name']; ?>" width="150" height="150" alt="" src="<?php echo $this->_var['shop']['logo']; ?>" /> 
    </a>
    <div class="flow-content">
      <h4 class="flow-title"> 
      	<a href="supplier.php?suppId=<?php echo $this->_var['shop']['supplier_id']; ?>" title="<?php echo $this->_var['shop']['supplier_name']; ?>"><span><?php echo $this->_var['shop']['supplier_name']; ?></span></a> 
        <?php if ($this->_var['shop']['shop_closed']): ?>
        <span class="guanzhu">装修中..</span>
        <?php else: ?>
        <span onclick='guanzhu(<?php echo $this->_var['shop']['supplier_id']; ?>);' class="guanzhu">关注</span>
        <?php endif; ?> 
      </h4>
      <p class="flow-logo"> 
      	<a href="supplier.php?suppId=<?php echo $this->_var['shop']['supplier_id']; ?>" style="float:none; display:inline-block;">
        	<img id="j_logo_<?php echo $this->_var['shop']['supplier_id']; ?>" alt="" width="90" height="45" src="<?php echo $this->_var['logopath']; ?>logo_supplier<?php echo $this->_var['shop']['supplier_id']; ?>.jpg">
        </a> 
      </p>
      <p class="flow-desc"> 
      	<span>卖家：</span> 
        ...
        <a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo $this->_var['shop']['qq']; ?>&site=qq&menu=yes" target="_blank" alt="点击这里联系我" title="点击这里联系我" class="flow-qq">
        	<img src="https://wpa.qq.com/pa?p=1:<?php echo $this->_var['shop']['qq']; ?>:4" height="16" border="0" alt="QQ" />
        </a> 
        <a href="https://amos1.taobao.com/msg.ww?v=2&uid=<?php echo $this->_var['shop']['ww']; ?>&s=2" target="_blank" class="flow-qq">
        	<img src="https://amos1.taobao.com/online.ww?v=2&uid=<?php echo $this->_var['shop']['ww']; ?>&s=2" width="16" height="16" border="0" alt="淘宝旺旺" />
        </a> 
      </p>
      <p class="flow-desc">
...
?>
              <li> 
              	<a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo $this->_var['goods']['goods_name']; ?>" target="_blank" class="img">
              		<img src="<?php echo $this->_var['goods']['goods_thumb']; ?>"> <span>￥<?php echo $this->_var['goods']['shop_p']; ?></span> 
                </a> 
