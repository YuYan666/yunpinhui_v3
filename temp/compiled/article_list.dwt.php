...
?> 
            <?php if ($this->_foreach['name']['iteration'] <= 1): ?>
            <li class="focus">
              <p><a href="<?php echo $this->_var['articleimg']['url']; ?>"><img class="view" alt="<?php echo $this->_var['articleimg']['title']; ?>" src="<?php if ($this->_var['articleimg']['img']['0']): ?><?php echo $this->_var['articleimg']['img']['0']; ?><?php else: ?>themes/wwwwe10cn/images/article_img.jpg<?php endif; ?>"></a></p>
...
?> 
            <?php if ($this->_foreach['name']['iteration'] > 1): ?>
            <li>
              <p><a href="<?php echo $this->_var['articleimg']['url']; ?>" target="_blank"><img class="view" alt="<?php echo $this->_var['articleimg']['title']; ?>" src="<?php if ($this->_var['articleimg']['img']['0']): ?><?php echo $this->_var['articleimg']['img']['0']; ?><?php else: ?>themes/wwwwe10cn/images/article_img.jpg<?php endif; ?>"></a></p>
              <p><a class="txt" title="<?php echo $this->_var['articleimg']['title']; ?>" target="_blank"
          href="<?php echo $this->_var['articleimg']['url']; ?>"><?php echo sub_str($this->_var['articleimg']['title'],10); ?></a></p>
            </li>
            <?php endif; ?> 
...
?>
  ...
  alt="<?php echo $this->_var['articleimg']['title']; ?>" src="<?php if ($this->_var['articleimg']['img']['0']): ?><?php echo $this->_var['articleimg']['img']['0']; ?><?php else: ?>themes/wwwwe10cn/images/article_img.jpg<?php endif; ?>"></a></p>
