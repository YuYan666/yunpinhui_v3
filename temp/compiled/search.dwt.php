...
?><?php if ($this->_var['key'] != "sort" && $this->_var['key'] != "order"): ?><?php echo $this->_var['key']; ?>=<?php echo $this->_var['item']; ?>&<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>page=<?php echo $this->_var['pager']['page']; ?>&sort=click_count&order=<?php if ($this->_var['pager']['search']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#list">人气<b class="icon-order-<?php if ($this->_var['pager']['search']['sort'] == 'click_count'): ?><?php echo $this->_var['pager']['search']['order']; ?><?php else: ?>DESC<?php endif; ?>ending"></b></a>
            ...
            <form action="compare.php" method="post" name="compareForm" id="compareForm" onsubmit="return compareGoods(this);">
                ...
                <?php if ($this->_var['beizhuxinxi_www_ahxcgg_com']): ?>
                <div style="width:100%;height:50px;margin:10px 0;overflow:hidden;text-align:center;"> <?php echo $this->_var['beizhuxinxi_www_ahxcgg_com']; ?> </div>
                <?php endif; ?>
                      ...
                      <div class="item-con"> 
                        ...
                        <div class="item-pic">
                        	<a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" target="_blank">
                            	<img data-original="<?php echo $this->_var['goods']['goods_thumb']; ?>" src="themes/wwwwe10cn/images/loading.gif" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" class="pic_img_<?php echo $this->_var['goods']['goods_id']; ?>">
                            </a>
                        </div>
                        ...
                        <div class="item-info">
                        	<div class="item-price">
                          	...
                          	<div class="item-name">
                            	<a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"><?php echo $this->_var['goods']['goods_name_www_we10_cn']; ?></a>
                            </div>
