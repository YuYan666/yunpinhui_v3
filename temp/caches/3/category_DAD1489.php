...
<title>跑步鞋_户外鞋服_服装服饰_甜心商城  </title>
...
<div class="aside-con">
  ...
  <form method="GET" name="listform" action="category.php">
    <div class="fore1">
      <dl class="order">
        <dd class="first "><a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架<b class="icon-order-DESCending"></b></a></dd>
        <dd class=""><a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=salenum&amp;order=DESC">销量<b class="icon-order-DESCending"></b></a></dd>
        <dd class=""><a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格<b class="icon-order-DESCending"></b></a></dd>
        <dd class="curr"><a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=last_update&amp;order=DESC">更新<b class="icon-order-ASCending"></b></a></dd>
        <dd class=""><a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=2&amp;page=1&amp;sort=click_count&amp;order=DESC">人气<b class="icon-order-DESCending"></b></a></dd>
      </dl>
      <div class="pagin"> 
    ...
    <div class="fore2">
      <div class="filter-btn"> <a class="filter-tag " href="category.php?in_stock=1&category=85&display=grid&brand=0&price_min=0&price_max=0&filter=2&filter_attr=0&page=1&is_stock=1&sort=last_update&order=ASC#goods_list" rel='nofollow'><i class="icon"></i><span class="text">仅显示有货</span></a>          
        <a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=0" class="filter-tag-radio "> <input class="none" type="radio" name="fff" onclick="top.location.href='category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=0'" > <i class="icon"></i> <span class="text">全部</span> </a> 
         
        <a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=1" class="filter-tag-radio "> <input class="none" type="radio" name="fff" onclick="top.location.href='category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=1'" > <i class="icon"></i> <span class="text">网站自营</span> </a> 
         
        <a href="category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=2" class="filter-tag-radio curr"> <input class="none" type="radio" name="fff" onclick="top.location.href='category.php?id=85&amp;price_min=0&amp;price_max=0&amp;filter=2'" checked> <i class="icon"></i> <span class="text">入驻商店铺</span> </a> 
