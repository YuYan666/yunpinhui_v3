...
<title>奇异果猕猴桃_进口水果_食品生鲜_甜心商城  </title>
...
<script type="text/javascript" src="themes/wwwwe10cn/js/nav.js"></script>
  ...
  <div class="w1210">
  		<div class="w">
  <div class="breadcrumb clearfix"><a href="." class="index">首页</a> <span class='crumbs-arrow'>&gt;</span> <div class='crumbs-nav crumbs-nav0'><a class='crumbs-title' href='category.php?id=1'>食品生鲜<i class='icon'></i></a><div class='crumbs-drop'><ul class='crumbs-drop-list'><li><a href='category.php?id=1'>食品生鲜</a></li><li><a href='category.php?id=2'>服装服饰</a></li><li><a href='category.php?id=3'>个护化妆</a></li><li><a href='category.php?id=4'>手机数码</a></li><li><a href='category.php?id=5'>家用电器</a></li><li><a href='category.php?id=6'>家纺家居</a></li><li><a href='category.php?id=7'>酒类饮料</a></li><li><a href='category.php?id=8'>母婴用品</a></li><li><a href='category.php?id=356'>虚拟分类</a></li></ul></div></div> <span class='crumbs-arrow'>&gt;</span> <div class='crumbs-nav crumbs-nav1'><a class='crumbs-title' href='category.php?id=14'>进口水果<i class='icon'></i></a><div class='crumbs-drop'><ul class='crumbs-drop-list'><li><a href='category.php?id=9'>牛奶乳品</a></li><li><a href='category.php?id=10'>坚果炒货</a></li><li><a href='category.php?id=12'>蜜饯果干</a></li><li><a href='category.php?id=13'>糖果巧克力</a></li><li><a href='category.php?id=14'>进口水果</a></li></ul></div></div> <span class='crumbs-arrow'>&gt;</span> <div class='crumbs-nav crumbs-nav2'><a class='crumbs-title' href='category.php?id=20'>奇异果猕猴桃<i class='icon'></i></a><div class='crumbs-drop'><ul class='crumbs-drop-list'><li><a href='category.php?id=15'>释迦芭乐</a></li><li><a href='category.php?id=16'>樱桃车厘子</a></li><li><a href='category.php?id=17'>芒果桃李</a></li><li><a href='category.php?id=18'>龙眼荔枝</a></li><li><a href='category.php?id=19'>提子葡萄</a></li><li><a href='category.php?id=20'>奇异果猕猴桃</a></li><li><a href='category.php?id=21'>凤梨蓝莓</a></li><li><a href='category.php?id=22'>榴莲山竹</a></li><li><a href='category.php?id=357'>橙子</a></li></ul></div></div></div>
</div>
<div class="blank"></div>
<script>
$(function(){
...
<div class="aside-con">
  ...
  <form method="GET" name="listform" action="category.php">
    <div class="fore1">
      <dl class="order">
        <dd class="first "><a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架<b class="icon-order-DESCending"></b></a></dd>
        <dd class=""><a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量<b class="icon-order-DESCending"></b></a></dd>
        <dd class=""><a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格<b class="icon-order-DESCending"></b></a></dd>
        <dd class="curr"><a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新<b class="icon-order-ASCending"></b></a></dd>
        <dd class=""><a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC">人气<b class="icon-order-DESCending"></b></a></dd>
      </dl>
      <div class="pagin"> 
    ...
    <div class="fore2">
      <div class="filter-btn"> <a class="filter-tag " href="category.php?in_stock=1&category=20&display=grid&brand=0&price_min=0&price_max=0&filter=0&filter_attr=0&page=1&is_stock=1&sort=last_update&order=ASC#goods_list" rel='nofollow'><i class="icon"></i><span class="text">仅显示有货</span></a>          
        <a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=0" class="filter-tag-radio curr"> <input class="none" type="radio" name="fff" onclick="top.location.href='category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=0'" checked> <i class="icon"></i> <span class="text">全部</span> </a> 
         
        <a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=1" class="filter-tag-radio "> <input class="none" type="radio" name="fff" onclick="top.location.href='category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=1'" > <i class="icon"></i> <span class="text">网站自营</span> </a> 
         
        <a href="category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=2" class="filter-tag-radio "> <input class="none" type="radio" name="fff" onclick="top.location.href='category.php?id=20&amp;price_min=0&amp;price_max=0&amp;filter=2'" > <i class="icon"></i> <span class="text">入驻商店铺</span> </a> 
