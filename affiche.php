    ...
    if (!empty($ad_info))
    {
        ...
        switch ($_GET['type'])
        {
            case '0':
                ...
                $src = (strpos($ad_info['ad_code'], 'http://') === false && strpos($ad_info['ad_code'], 'https://') === false) ? (OSS_DISPLAY_MODE==0) ? OSS_DOMAIN . DATA_DIR . "/afficheimg/$ad_info[ad_code]" : (OSS_DISPLAY_MODE==1 ? OSS_BINDING_DOMAIN . DATA_DIR . "/afficheimg/$ad_info[ad_code]" : $url . DATA_DIR . "/afficheimg/$ad_info[ad_code]") : $ad_info['ad_code'];
